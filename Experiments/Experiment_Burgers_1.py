...
# main_params=pd.read_excel('experiment_init_params_burgers_1.xlsx',dtype={'has_backward':bool})

# main_params=pd.read_excel('experiment_init_params_Burgers_1RK3_AuthorsParams.xlsx',dtype={'has_backward':bool})

main_params=pd.read_excel('experiment_init_params_Burgers_1_easy_params.xlsx',dtype={'has_backward':bool})
